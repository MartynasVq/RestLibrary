...
public class Book {
    ...
    public Book(String name, String author, String category, String language, LocalDate publicationDate, String isbn, UUID uuid) {
        this.name = name;
        this.author = author;
    ...
    public Book(String name, String author, String category, String language, LocalDate publicationDate, String isbn, UUID uuid, boolean available,
    ...
    public String toString() {
        return "Book(name=" + this.getName() + ", author=" + this.getAuthor() + ", category=" + this.getCategory() + ", language=" + this.getLanguage() + ", publicationDate=" + this.getPublicationDate() + ", isbn=" + this.getIsbn() + ", id=" + this.getId() + ", available=" + this.isAvailable() + ", borrowedBy=" + this.getBorrowedBy() + ", borrowedUntil=" + this.getBorrowedUntil() + ")";
    }
